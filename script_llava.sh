...
# cd ../..
accelerate launch --num_processes 1 --main_process_port 22901 -m lmms_eval \
    --model longva \
    --model_args pretrained=/data/DERI-Gong/jh015/Video-XL/assets/VideoXL_weight_8,conv_template=qwen_1_5,model_name=llava_qwen,max_frames_num=192,video_decode_backend=decord\
    --tasks videomme \
    --batch_size 1 \
    --log_samples \
